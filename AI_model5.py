...
def preprocess_data(data, window_size=70):
...
# Preprocess data
X, y = preprocess_data(data, window_size=70)
...
def create_model(trial):
    ...
    # Compile the model
    model.compile(optimizer=Nadam(learning_rate=0.0015), loss='binary_crossentropy', metrics=['accuracy'])
...
history = best_model.fit(X_train_scaled, y_train, epochs=35, batch_size=32, verbose=1,
